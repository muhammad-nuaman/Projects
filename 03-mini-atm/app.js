...
let myBalance = 10000; // set amount
let myPinCode = 12345; // set pin code
// Get Pin Code
...
if (pin.code === myPinCode) {
    ...
    // Option: Withdraw
        ...
        if (select.option === 'write amount') {
            (async function amount() {
                ...
                if (withdraw.amount < 0 ||
                    ...
                    // Remaining Balance
                    console.log(`${chalk.bold('Withdraw Amount: ')}` +
        ...
        // Fast Amount
            ...
            // Remaining Balance
            console.log(`${chalk.bold('Remaining Balance: ')}` +
                `${chalk.green(myBalance.toLocaleString('en-in'))}
            `);
        }
    }
...
// Incorrect Pin Code
    ...
    console.log(chalk.bold('Pin Code: '), chalk.red('Incorrect!'));
