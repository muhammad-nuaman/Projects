...
function calculator() {
    ...
    // Second Valuation
    //=============================================================
    async function secondValuation(firstValue) {
        // prompt 
        ...
        if (second.value || second.value === 0) {
            selection(firstValue, second.value);
        }
        else
            secondValuation(firstValue);
    }
    //=============================================================
    // selection
    //=============================================================
    async function selection(firstValue, secondValue) {
    ...
    // calculation
    //=============================================================
    async function calculation(firstValue, secondValue, operator) {
        let result = 0;
        // Addition
